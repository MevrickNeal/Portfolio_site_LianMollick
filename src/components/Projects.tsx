...
const projectGroups = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        live: null,
        preview: "/lovable-uploads/8c15f52e-3b9c-4253-8c71-1d62bf2ba066.png",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        desc: "Robotic arm controller using camera-based computer vision. The prosthetic OS interprets hand gestures and finger positions from live camera feed and maps them to servo motor commands for a 5-DOF robotic arm.",
        tags: ["OpenCV", "Python", "Servo Control", "Prosthetics"],
        github: "https://github.com/MevrickNeal/Cyber_ProstheticOS",
        live: null,
        preview: "/lovable-uploads/4110bdb4-908d-4993-ba9d-6df3c08c8453.png",
      },
      {
        num: "07",
        ...
        live: null,
        preview: "/lovable-uploads/3517d79a-d999-4d53-9657-4b63294aff2c.png",
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        desc: "IoT-based smart water purifier filter cartridge change notifier. Monitors water flow accumulation using a flow sensor and ESP32, then sends push notifications when the filter cartridge needs replacement — preventing degraded water quality.",
        tags: ["IoT", "ESP32", "Smart Home", "Water Safety"],
        github: "https://github.com/MevrickNeal/DrWaterSmartCounter",
        live: null,
        preview: "/lovable-uploads/603836fa-feeb-4a00-b7fd-0bd5609a9888.png",
      },
    ],
  },
];
